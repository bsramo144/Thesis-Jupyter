...
#  Default: '/srv/conda/envs/notebook/etc/jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/srv/conda/envs/notebook/etc/jupyter/lab/user-settings'
...
#  Default: '/srv/conda/envs/notebook/etc/jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/srv/conda/envs/notebook/etc/jupyter/lab/workspaces'
